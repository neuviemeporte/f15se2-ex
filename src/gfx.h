...
void gfx_flipPage();                                                /* slot 0x46: vblank + flip to VGA */
void gfx_blitSpriteClipped(int16 *ptr);                             /* slot 0x47: sprite variant */
void gfx_blitSpriteOpaque(int16 *ptr);                              /* slot 0x49: sprite blit (=0x11) */
/* dseg:0xc2f */
int16 gfx_getModeFlag();                         /* slot 0x4c: getModeFlag */
void gfx_setDacAnimCount(uint16 count);        /* slot 0x4f: setDacAnimCount */
void gfx_commitPage();                         /* slot 0x50: commitPage */
