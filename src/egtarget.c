...
void updateTargetLock(void) {
    ...
    int16 p0, a0, b0, c0, d0, e0, deadInit, lockedRange, h0, dk;
...
void drawHudWorldOverlay(void) {
    int16 p, lockFlag, r, wpEntry, tmp, t, missileSpecD, loftDist, e, missileSpec, marker, idx, g, radius, objIdx, pointY, pointX, dist, wpIdx, prevX, compat, prevY;
